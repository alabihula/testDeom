...
Dep.prototype.depend = function depend () {
  if (Dep.target) {
    //minxing---console
    console.log('Dep depend this:调用Watcher的addDep方法，将自身watcher实例加入到subs中',this);
...
function defineReactive (
  ...
  Object.defineProperty(obj, key, {
    ...
    get: function reactiveGetter () {
      ...
      if (Dep.target) {
        //minxing---console
        console.log('defineProperty get dep.depend==========')
        dep.depend();
        if (childOb) {
          childOb.dep.depend();
          if (Array.isArray(value)) {
...
function dependArray (value) {
  //minxing---console
  console.log('dependArray value',value)
...
var Watcher = function Watcher (
  ...
  if (typeof expOrFn === 'function') {
    console.log('Watcher getter exOrFn',expOrFn)
    this.getter = expOrFn;
  } else {
    console.log('Watcher getter parsePath-exOrFn',expOrFn)
...
Watcher.prototype.get = function get () {
  console.log('Watcher get===========target数组添加target:watcher实例')
  pushTarget(this);
  var value;
  var vm = this.vm;
  try {
    ...
    //minxing---console
    console.log('Watcher get===========删除target数组中的最后一个target')
    popTarget();
    this.cleanupDeps();
  }
  return value
...
Watcher.prototype.run = function run () {
  if (this.active) {
    ...
    if (
      ...
      console.log('Watcher run---set new value',this.value);
      // set new value
...
Watcher.prototype.depend = function depend () {
  var this$1 = this;
  //minxing---console
  console.log('Watcher depend',this$1);
  var i = this.deps.length;
  while (i--) {
