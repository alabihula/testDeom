! function(a, b) {
	function s() {
		var b = d.getBoundingClientRect().width,
			c = b / 10;
		d.style.fontSize = c + "px", j.rem = a.rem = c
	}
	var i, k, l, m, n, p, q, r, c = a.document,
		d = c.documentElement,
